...
export default function CardSearchs() {
    ...
    return(
    <Card padding='0' width={['90%','80%', '80%', '75%']} bg='white' border='1px solid whitesmoke' alignSelf='center' borderRadius='var(--chakra-radii-xl)' mb='1rem' size='sm' direction='row' overflow='hidden'>
